        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CurrentChapterId = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false),
                    CurrentLocationId = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false),
                    CompletedMilestonesJson = table.Column<string>(type: "text", nullable: false),
                    KnownNpcIdsJson = table.Column<string>(type: "text", nullable: false),
                    DiscoveredLocationsJson = table.Column<string>(type: "text", nullable: false),
                    PartyStateJson = table.Column<string>(type: "text", nullable: false),
                    ActiveQuestsJson = table.Column<string>(type: "text", nullable: false),
                    ActiveCombatJson = table.Column<string>(type: "text", nullable: true),
                    NarrativeLogJson = table.Column<string>(type: "text", nullable: false),
                    PreferencesJson = table.Column<string>(type: "text", nullable: false),
                    LastNarrativeSummary = table.Column<string>(type: "TEXT", maxLength: 5000, nullable: true),
                    ActivePlayerChoicesJson = table.Column<string>(type: "text", nullable: false),
                    CurrentSceneImageUri = table.Column<string>(type: "TEXT", maxLength: 500, nullable: true),
                    CurrentReadAloudText = table.Column<string>(type: "TEXT", maxLength: 5000, nullable: true)
                },
                constraints: table =>
                {
